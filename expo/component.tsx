 ...
 */
export function KeyOnboarding({ onSuccess, onSaveKey, containerStyle }: KeyOnboardingProps) {
    ...
    <View style={[styles.container, containerStyle]}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>
          This app runs locally on your device. To get started, paste your free Google Gemini API
          key.
        </Text>
